        ...
        {mode === 'edit' && (
          <div className="flex-1 overflow-y-auto p-4 space-y-6">
            ...
            <div className="grid grid-cols-4 gap-2">
              {toolCategory === 'tiles' ? (
                <>
                  <ToolButton active={selectedTool === 'wall'} onClick={() => setSelectedTool('wall')} icon={<div className="w-6 h-6 rounded-sm" style={{ backgroundImage: `url("data:image/svg+xml,%3Csvg width='28' height='28' xmlns='http://www.w3.org/2000/svg'%3E%3Crect width='28' height='28' fill='%23492009'/%3E%3Crect x='0' y='0' width='26' height='12' fill='%23c2692d' rx='1'/%3E%3Crect x='0' y='0' width='26' height='2' fill='%23d4883a' rx='1' opacity='0.5'/%3E%3Crect x='0' y='14' width='12' height='12' fill='%23c2692d' rx='1'/%3E%3Crect x='0' y='14' width='12' height='2' fill='%23d4883a' rx='1' opacity='0.5'/%3E%3Crect x='14' y='14' width='14' height='12' fill='%23c2692d' rx='1'/%3E%3Crect x='14' y='14' width='14' height='2' fill='%23d4883a' rx='1' opacity='0.5'/%3E%3C/svg%3E")`, backgroundSize: '14px 14px' }} />} label="Brick" tooltip="Solid brick wall — nothing can pass through" />
