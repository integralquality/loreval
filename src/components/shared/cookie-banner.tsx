...
export function CookieBanner() {
  ...
  const btnPrimary = `${btnBase} bg-purple-600 hover:bg-purple-500 text-white`;
  const btnOutline = `${btnBase} border border-zinc-700 text-zinc-300 hover:bg-zinc-800 hover:text-white`;
      ...
      <div className="mx-auto max-w-6xl">
        {!showDetails ? (
          ...
          <div className="space-y-4">
            <p className="text-sm font-medium text-zinc-200">Cookie Preferences</p>
            <div className="space-y-3">
              <label className="flex items-center justify-between">
                <div>
                  <p className="text-sm font-medium text-zinc-300">Essential</p>
                  <p className="text-xs text-zinc-500">Required for the app to function. Always enabled.</p>
                </div>
                <input type="checkbox" checked disabled className="h-4 w-4 accent-purple-500" />
              </label>
              <label className="flex items-center justify-between">
                <div>
              ...
              <label className="flex items-center justify-between">
                <div>
                  <p className="text-sm font-medium text-zinc-300">Marketing</p>
