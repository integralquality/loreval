...
export default function SharedLevelPage() {
  ...
  if (loading) {
    return (
      <div className="flex items-center justify-center min-h-screen page-ground">
  ...
  if (!levelData) {
    return (
      <div className="flex flex-col items-center justify-center min-h-screen page-ground text-center px-6">
        ...
        <Link to="/browse" className="font-mono text-orange-400 hover:text-orange-300 text-sm">
          browse levels
        </Link>
      </div>
    );
  ...
  if (!parsed) {
    return (
      <div className="flex flex-col items-center justify-center min-h-screen page-ground text-center px-6">
        <h1 className="text-2xl font-bold text-zinc-100 mb-3">Failed to load level</h1>
        <Link to="/browse" className="font-mono text-orange-400 hover:text-orange-300 text-sm">
          browse levels
        </Link>
      </div>
