...
function HeroGrid() {
  ...
  return (
    <div className="relative p-6 border border-white/10 bg-zinc-900/30 backdrop-blur-xl rounded-2xl">
      ...
      <div
        className="grid gap-1 bg-zinc-800/10 p-1 rounded-xl mt-6"
        style={{
      ...
      <div className="mt-3 font-mono text-[9px] text-zinc-600">move {step + 1}/{path.length}</div>
    </div>
  );
}
...
export default function HomePage() {
  return (
    <div className="bg-zinc-950 text-zinc-300 font-sans selection:bg-purple-500/30">
      ...
      {/* WHAT IT EVALUATES */}
      <section className="border-y border-zinc-800/60 py-28 relative">
        <div className="absolute inset-0 bg-gradient-to-b from-zinc-900/30 to-transparent pointer-events-none" />
        <div className="max-w-5xl mx-auto px-6 relative">
          <p className="text-[10px] font-mono uppercase tracking-widest text-zinc-500 mb-14">What it evaluates</p>
          <div className="grid lg:grid-cols-2 gap-px bg-zinc-800/40 rounded-2xl overflow-hidden border border-zinc-800/60">
            ...
            <div className="bg-zinc-950 p-10">
              <div className="flex items-center gap-3 mb-6">
                ...
                <h3 className="text-lg font-semibold text-white">Solving</h3>
              </div>
            ...
            <div className="bg-zinc-950 p-10">
              <div className="flex items-center gap-3 mb-6">
                ...
                <h3 className="text-lg font-semibold text-white">Designing</h3>
              </div>
              <p className="text-zinc-400 text-sm leading-relaxed mb-5">
      ...
      <section className="max-w-5xl mx-auto px-6 py-28">
        <p className="text-[10px] font-mono uppercase tracking-widest text-zinc-500 mb-14">Puzzle format</p>
        <div className="grid lg:grid-cols-2 gap-16 items-start">
          <div>
            <h3 className="text-xl font-semibold text-white mb-5">A text-based DSL</h3>
            <p className="text-zinc-400 text-sm leading-relaxed mb-5">
          ...
          <div className="rounded-xl border border-zinc-800 overflow-hidden">
            <div className="flex items-center gap-2 px-4 py-2.5 border-b border-zinc-800 bg-zinc-900">
              ...
              <span className="font-mono text-[10px] text-zinc-600 ml-1">level.puzzle</span>
            </div>
            <div className="bg-zinc-900/60 p-6 font-mono text-xs leading-6 text-zinc-400">
      ...
      {/* LIVE DEBUGGING */}
      <section className="border-t border-zinc-800/60 py-28 relative">
        <div className="absolute inset-0 bg-gradient-to-b from-zinc-900/20 to-transparent pointer-events-none" />
        <div className="max-w-5xl mx-auto px-6 relative">
          <p className="text-[10px] font-mono uppercase tracking-widest text-zinc-500 mb-14">Inspecting a solve attempt</p>
          <div className="grid lg:grid-cols-2 gap-16 items-start">
            ...
            <div className="rounded-xl border border-zinc-800 overflow-hidden sticky top-8">
              <div className="flex items-center gap-2 px-4 py-2.5 border-b border-zinc-800 bg-zinc-900">
                ...
                <span className="font-mono text-[10px] text-zinc-600 ml-1">move log · paused</span>
              </div>
              <div className="bg-zinc-900/60 p-6 font-mono text-xs leading-7 space-y-0.5">
                {[
                  'orange  (1,4) → (1,3)  up',
                ...
                <div className="pt-4 border-t border-zinc-800 mt-3 flex justify-between text-zinc-600">
                  <span>move 5 / 10</span>
                  <span className="text-emerald-500/60">✓ solved</span>
                </div>
              </div>
            </div>
      ...
      {/* WHY THIS SETUP */}
      <section className="max-w-5xl mx-auto px-6 py-28">
        <p className="text-[10px] font-mono uppercase tracking-widest text-zinc-500 mb-14">Why this setup</p>
        <div className="grid lg:grid-cols-3 gap-8">
          {[
            ...
            <div key={title} className="border border-zinc-800/60 rounded-xl p-6 bg-zinc-900/20">
      ...
      {/* HOW TO USE */}
      <section className="border-t border-zinc-800/60 py-28">
        <div className="max-w-5xl mx-auto px-6">
          <p className="text-[10px] font-mono uppercase tracking-widest text-zinc-500 mb-14">Using it</p>
          <div className="grid md:grid-cols-3 gap-8">
            {[
              ...
              <div key={n} className="relative pl-6 border-l border-zinc-800">
                <p className="font-mono text-[10px] text-zinc-600 mb-3">{n}</p>
      ...
      <section className="relative max-w-5xl mx-auto px-6 py-32">
        ...
        <motion.div initial={{ opacity: 0 }} whileInView={{ opacity: 1 }} viewport={{ once: true }} className="relative">
          ...
          <Link to="/designer" className="inline-flex items-center gap-2 text-purple-400 text-sm font-medium hover:text-purple-300 transition-colors group">
